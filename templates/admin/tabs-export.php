				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php _e( 'Volume offset and limit allows for partial exporting of a export type (e.g. records 0 to 500, etc.). This is useful when encountering timeout and/or memory errors during the a large or memory intensive export. To be used effectively both fields must be filled. By default this is not used and is left empty.', 'wpsc_ce' ); ?></p>
						</td>
					</tr>
