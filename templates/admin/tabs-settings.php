		...
		<tbody>
			...
			<tr id="general-settings">
				<td colspan="2" style="padding:0;">
					<h3><?php _e( 'General Settings', 'wpsc_ce' ); ?></h3>
				</td>
			</tr>
			...
			<tr valign="top">
				...
				<td>
					...
					<p class="description"><?php _e( 'The filename of the exported export type. Tags can be used: ', 'wpsc_ce' ); ?> <code>%dataset%</code>, <code>%date%</code>, <code>%time%</code>, <code>%store_name%</code>.</p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<select id="delete_temporary_csv" name="delete_temporary_csv">
						<option value="0"<?php selected( $delete_csv, 0 ); ?>><?php _e( 'Yes', 'wpsc_ce' ); ?></option>
						<option value="1"<?php selected( $delete_csv, 1 ); ?>><?php _e( 'No', 'wpsc_ce' ); ?></option>
					</select>
					<p class="description"><?php _e( 'Save copies of CSV exports to the WordPress Media for downloading later. By default this option is turned on.', 'wpsc_ce' ); ?></p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<select id="timeout" name="timeout">
						<option value="600"<?php selected( $timeout, 600 ); ?>><?php printf( __( '%s minutes', 'wpsc_ce' ), 10 ); ?></option>
						<option value="1800"<?php selected( $timeout, 1800 ); ?>><?php printf( __( '%s minutes', 'wpsc_ce' ), 30 ); ?></option>
...
<?php } ?>
			...
			<tr id="csv-settings">
				<td colspan="2" style="padding:0;">
					<hr />
					<h3><?php _e( 'CSV Settings', 'wpsc_ce' ); ?></h3>
				</td>
			</tr>
	...
	<p class="submit">
		<input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e( 'Save Changes', 'wpsc_ce' ); ?>" />
	</p>
